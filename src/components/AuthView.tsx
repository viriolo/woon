    ...
    index 143dde607a8078fed05de89857c9376f413290c2..171432591313dfbb6475c0f53bb98bd1e3a454b4 100644
    --- a/src/components/AuthView.tsx
    +++ b/src/components/AuthView.tsx
    @@ -84,146 +76,156 @@ export default function AuthView({ onClose, prompt }: AuthViewProps) {
             }
