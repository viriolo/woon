                        ...
                        <form onSubmit={handleSubmit} className="auth-form">
                            {mode === "signup" && (
                                <div className="auth-input-group">
                                    <label htmlFor="dashboard-auth-name">Full name</label>
                                    <input
                                        id="dashboard-auth-name"
                                        type="text"
                                        value={name}
                            ...
                            <div className="auth-input-group">
                                <label htmlFor="dashboard-auth-email">Email address</label>
                                <input
                            ...
                            <div className="auth-input-group">
                                <label htmlFor="dashboard-auth-password">Password</label>
                                <input
