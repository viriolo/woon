...
const initialMockComments: Comment[] = [
    { id: 'comment-1-1', celebrationId: 1, authorId: 'mock-2', authorName: 'David L.', text: 'Looks so peaceful! I love watercolor.', timestamp: new Date(Date.now() - 1000 * 60 * 5).toISOString() },
    { id: 'comment-1-2', celebrationId: 1, authorId: 'mock-3', authorName: 'Chloe T.', text: 'Beautiful setup!', timestamp: new Date(Date.now() - 1000 * 60 * 2).toISOString() },
    { id: 'comment-2-1', celebrationId: 2, authorId: 'mock-1', authorName: 'Maria S.', text: 'Wow, that must have taken forever!', timestamp: new Date(Date.now() - 1000 * 60 * 10).toISOString() },
];
